...
<template>
  <div class="chineseErrorCorrection">
    <h1>中文文本纠错</h1>
    <div class="main">
      <el-button type="primary" size="large" style="margin-left: 35px" @click="buttonFn(1)">
        文本输入
      </el-button>
      <el-button type="primary" size="large" style="margin-left: 35px" @click="buttonFn(2)">
        上传文件
      </el-button>
      <el-drawer v-model="drawer" :before-close="drawerClose" direction="btt" title=" 文本输入">
        <template #default>
          <el-input
            v-model="textarea"
            maxlength="300"
        ...
        <template #footer>
          <div class="footerBoyyon" style="flex: auto">
